...
int _expensesEstimateSize(
  ...
  bytesCount += 3 + object.catgory.length * 3;
...
void _expensesSerialize(
  ...
  writer.writeString(offsets[1], object.catgory);
...
Expenses _expensesDeserialize(
  ...
  final object = Expenses(
    ...
    catgory: reader.readString(offsets[1]),
...
extension ExpensesQueryFilter
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryEqualTo(
    String value, {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'catgory',
        value: '',
  ...
  QueryBuilder<Expenses, Expenses, QAfterFilterCondition> catgoryIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'catgory',
        value: '',
...
extension ExpensesQuerySortBy on QueryBuilder<Expenses, Expenses, QSortBy> {
  ...
  QueryBuilder<Expenses, Expenses, QAfterSortBy> sortByCatgory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catgory', Sort.asc);
    });
  }

  QueryBuilder<Expenses, Expenses, QAfterSortBy> sortByCatgoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catgory', Sort.desc);
    });
  }
...
extension ExpensesQuerySortThenBy
  ...
  QueryBuilder<Expenses, Expenses, QAfterSortBy> thenByCatgory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catgory', Sort.asc);
    });
  }

  QueryBuilder<Expenses, Expenses, QAfterSortBy> thenByCatgoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'catgory', Sort.desc);
    });
  }
...
extension ExpensesQueryWhereDistinct
  ...
  QueryBuilder<Expenses, Expenses, QDistinct> distinctByCatgory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'catgory', caseSensitive: caseSensitive);
    });
  }
...
extension ExpensesQueryProperty
  ...
  QueryBuilder<Expenses, String, QQueryOperations> catgoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'catgory');
    });
  }
